...
[![GitHub package.json version](https://img.shields.io/badge/Unity-5.2.6-blue)](../../releases)
...
[![GitHub package.json version](https://img.shields.io/badge/iOS-5.2.6-blue)](https://github.com/adiscope/Adiscope-iOS-Sample)
...
#### A. Set Lucky Event
```csharp
Adiscope.Sdk.GetCoreInstance().SetLuckyEventAppId(APP_ID, PUB_ID);
```
- APP_ID, PUB_ID는 관리자에게 발급 요청
<br/>

#### B. Show Lucky Event
```csharp
Adiscope.Sdk.GetCoreInstance().ShowLuckyEvent();
```
<br/><br/><br/>
