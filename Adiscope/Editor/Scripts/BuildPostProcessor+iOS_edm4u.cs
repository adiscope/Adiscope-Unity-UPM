...
namespace Adiscope
{
    ...
    static class AdiscopeFrameworkTypeExtension {
        ...
        private const string CORE_FILE_PATH         = ADISCOPE_FILE_PATH + "4.0.0/";
        private const string ADEVENT_FILE_PATH      = ADISCOPE_FILE_PATH + "4.0.0/";
        private const string ADMANAGER_FILE_PATH    = ADISCOPE_FILE_PATH + "4.0.0/";
        private const string ADMOB_FILE_PATH        = ADISCOPE_FILE_PATH + "4.0.0/";
        private const string VUNGLE_FILE_PATH       = ADISCOPE_FILE_PATH + "4.0.0/";
        private const string CHARTBOOST_FILE_PATH   = ADISCOPE_FILE_PATH + "4.0.0/";
        private const string MAX_FILE_PATH          = ADISCOPE_FILE_PATH + "4.0.0/";
        private const string PANGLE_FILE_PATH       = ADISCOPE_FILE_PATH + "4.0.0/";
