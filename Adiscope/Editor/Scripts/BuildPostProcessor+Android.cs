...
namespace Adiscope
{
    ...
    static class AdiscopeFrameworkAndroidTypeExtension
    {
        ...
        private const string CHARTBOOST_FILE_PATH   = ADISCOPE_FILE_PATH + "4.0.1/";
        private const string MAX_FILE_PATH          = ADISCOPE_FILE_PATH + "4.0.1/";
        private const string PANGLE_FILE_PATH       = ADISCOPE_FILE_PATH + "4.0.1/";
