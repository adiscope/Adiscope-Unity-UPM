...
namespace Adiscope
{
    ...
    static class AdiscopeFrameworkAndroidTypeExtension
    {
        ...
        private const string CHARTBOOST_FILE_PATH   = ADISCOPE_FILE_PATH + "3.10.6/";
        private const string MAX_FILE_PATH          = ADISCOPE_FILE_PATH + "3.10.6/";
        private const string PANGLE_FILE_PATH       = ADISCOPE_FILE_PATH + "3.10.6/";
