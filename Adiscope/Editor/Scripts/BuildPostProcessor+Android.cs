...
namespace Adiscope
{
    ...
    static class AdiscopeFrameworkAndroidTypeExtension
    {
        ...
        private const string ADMOB_FILE_PATH        = ADISCOPE_FILE_PATH + "4.1.0/";
        private const string CHARTBOOST_FILE_PATH   = ADISCOPE_FILE_PATH + "4.1.0/";
        private const string MAX_FILE_PATH          = ADISCOPE_FILE_PATH + "4.1.3/";
        private const string PANGLE_FILE_PATH       = ADISCOPE_FILE_PATH + "4.1.0/";
